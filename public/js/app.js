...
new Vue({
  ...
  methods: {
    getDatesBetween: function getDatesBetween(startDate, endDate) {
      ...
      while (currentDate <= new Date(endDate)) {
        dates.push({
          ...
          label: "".concat(currentDate.getDate(), " ").concat(new Intl.DateTimeFormat('en-US', {
            weekday: 'short'
          }).format(currentDate))
        });
    ...
    getCurrentMonthCalendar: function getCurrentMonthCalendar() {
      var date = new Date(),
          y = date.getFullYear(),
          m = date.getMonth();
    ...
    submit: function submit(e) {
      ...
      return _asyncToGenerator( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().mark(function _callee() {
        var _yield$axios$post, _yield$axios$post$dat, from, to, days, event, daysArr;
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                _context.next = 4;
                return axios.post('api/events', new FormData(e.target));

              case 4:
                _yield$axios$post = _context.sent;
                _yield$axios$post$dat = _yield$axios$post.data.data.event;
                from = _yield$axios$post$dat.from;
                to = _yield$axios$post$dat.to;
                days = _yield$axios$post$dat.days;
                event = _yield$axios$post$dat.event;
                daysArr = days.map(function (day) {
                  return Number(day.day);
                });
                _this.dates = _this.getDatesBetween(from, to, daysArr, event);

                _this.$toast.success('Event successfully saved');
  ...
  computed: {
    calendarTitle: function calendarTitle() {
      ...
      label = from.getMonth() === to.getMonth() && from.getFullYear() === to.getFullYear() ? "".concat(from.toLocaleString('default', {
        month: 'short'
      }), " ").concat(from.getFullYear()) : "".concat(from.toLocaleString('default', {
        month: 'short'
      }), " ").concat(from.getFullYear(), " - ").concat(to.toLocaleString('default', {
        month: 'short'
      }), " ").concat(to.getFullYear());
      return label;
    },
    paginatedDates: function paginatedDates() {
      var start = (this.pagination.page - 1) * this.pagination.perPage;
      var end = this.pagination.page * this.pagination.perPage;
...
/***/ "./node_modules/css-loader/dist/cjs.js??ruleSet[1].rules[6].oneOf[1].use[1]!./node_modules/postcss-loader/dist/cjs.js??ruleSet[1].rules[6].oneOf[1].use[2]!./node_modules/vue-toast-notification/dist/theme-sugar.css":
/*!****************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/css-loader/dist/cjs.js??ruleSet[1].rules[6].oneOf[1].use[1]!./node_modules/postcss-loader/dist/cjs.js??ruleSet[1].rules[6].oneOf[1].use[2]!./node_modules/vue-toast-notification/dist/theme-sugar.css ***!
  \****************************************************************************************************************************************************************************************************************************/
...
/* harmony import */ var _css_loader_dist_cjs_js_ruleSet_1_rules_6_oneOf_1_use_1_postcss_loader_dist_cjs_js_ruleSet_1_rules_6_oneOf_1_use_2_theme_sugar_css__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! !!../../css-loader/dist/cjs.js??ruleSet[1].rules[6].oneOf[1].use[1]!../../postcss-loader/dist/cjs.js??ruleSet[1].rules[6].oneOf[1].use[2]!./theme-sugar.css */ "./node_modules/css-loader/dist/cjs.js??ruleSet[1].rules[6].oneOf[1].use[1]!./node_modules/postcss-loader/dist/cjs.js??ruleSet[1].rules[6].oneOf[1].use[2]!./node_modules/vue-toast-notification/dist/theme-sugar.css");
...
var update = _style_loader_dist_runtime_injectStylesIntoStyleTag_js__WEBPACK_IMPORTED_MODULE_0___default()(_css_loader_dist_cjs_js_ruleSet_1_rules_6_oneOf_1_use_1_postcss_loader_dist_cjs_js_ruleSet_1_rules_6_oneOf_1_use_2_theme_sugar_css__WEBPACK_IMPORTED_MODULE_1__["default"], options);



/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (_css_loader_dist_cjs_js_ruleSet_1_rules_6_oneOf_1_use_1_postcss_loader_dist_cjs_js_ruleSet_1_rules_6_oneOf_1_use_2_theme_sugar_css__WEBPACK_IMPORTED_MODULE_1__["default"].locals || {});
